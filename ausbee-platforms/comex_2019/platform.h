...
#define PLATFORM_GPIO_START_COCONIUM  (1 << 13)

#define PLATFORM_TIMER_SERVO          MCUAL_TIMER4
#define PLATFORM_SERVO_0              (1 << 0)
#define PLATFORM_SERVO_1              (1 << 1)
