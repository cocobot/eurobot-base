...
#define PLATFORM_GPIO_SW_1            (1 << 0)
#define PLATFORM_GPIO_SW_2            (1 << 1)
#define PLATFORM_GPIO_SW_3            (1 << 2)
#define PLATFORM_GPIO_SW_4            (1 << 3)
#define PLATFORM_GPIO_SW_5            (1 << 4)
#define PLATFORM_GPIO_SW_6            (1 << 5)
#define PLATFORM_GPIO_SW_7            (1 << 6)
#define PLATFORM_GPIO_SW_8            (1 << 7)
