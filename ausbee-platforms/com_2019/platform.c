...
void platform_init(void)
{
  ...
  mcual_gpio_set_pull_resistor(MCUAL_GPIOA, MCUAL_GPIO_PIN0 | MCUAL_GPIO_PIN1 | MCUAL_GPIO_PIN2 | MCUAL_GPIO_PIN3 | MCUAL_GPIO_PIN4 | MCUAL_GPIO_PIN6 | MCUAL_GPIO_PIN7, MCUAL_GPIO_PULL_UP_RESISTOR);
  mcual_gpio_set_pull_resistor(MCUAL_GPIOC, MCUAL_GPIO_PIN4, MCUAL_GPIO_PULL_UP_RESISTOR);
  ...
  mcual_gpio_init(MCUAL_GPIOD, MCUAL_GPIO_PIN5, MCUAL_GPIO_OUTPUT);
  mcual_gpio_init(MCUAL_GPIOD, MCUAL_GPIO_PIN6, MCUAL_GPIO_INPUT);
