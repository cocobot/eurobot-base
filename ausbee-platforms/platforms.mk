...
ifeq ($(CONFIG_PLATFORM_BRAIN_2018),y)
include $(CONFIG_CUSTOM_PLATFORMS_PATH)/brain_2018/platform.mk
PLATFORM_CLEAN_GOAL+=platform_brain_2018-clean
endif
...
ifeq ($(CONFIG_PLATFORM_STEP_2015),y)
include $(CONFIG_CUSTOM_PLATFORMS_PATH)/step_2015/platform.mk
PLATFORM_CLEAN_GOAL+=step_2015-clean
endif
