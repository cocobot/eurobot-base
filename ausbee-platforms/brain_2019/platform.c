...
void platform_init(void)
{
  ...
  mcual_gpio_set_function(MCUAL_GPIOA, MCUAL_GPIO_PIN0, 2);
  mcual_gpio_set_function(MCUAL_GPIOA, MCUAL_GPIO_PIN1, 2);

  //enc left
  mcual_gpio_init(MCUAL_GPIOA, MCUAL_GPIO_PIN15, MCUAL_GPIO_INPUT);
  mcual_gpio_init(MCUAL_GPIOB, MCUAL_GPIO_PIN3, MCUAL_GPIO_INPUT);
  mcual_gpio_set_function(MCUAL_GPIOA, MCUAL_GPIO_PIN15, 1);
  mcual_gpio_set_function(MCUAL_GPIOB, MCUAL_GPIO_PIN3, 1);
