...
#define MECA_UMBRELLA_ROT_SERVO_ID         PLATFORM_SERVO_4_ID
#define MECA_UMBRELLA_OPN_SERVO_ID         PLATFORM_SERVO_1_ID

#define MECA_UMBRELLA_ROT_SERVO_CLOSE 250
#define MECA_UMBRELLA_ROT_SERVO_OPEN 420
#define MECA_UMBRELLA_ROT_SERVO_DISABLE 0

#define MECA_UMBRELLA_OPN_SERVO_CLOSE 340
#define MECA_UMBRELLA_OPN_SERVO_OPEN 410
