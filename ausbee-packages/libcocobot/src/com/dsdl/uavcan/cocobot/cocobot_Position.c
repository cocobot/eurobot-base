  ...
  uint8_t CANARD_MAYBE_UNUSED(tao))
{
    ...
    ret = canardDecodeScalar(transfer, offset, 32, false, (void*)&dest->x);
    if (ret != 32)
    {
    ...
    ret = canardDecodeScalar(transfer, offset, 32, false, (void*)&dest->y);
    if (ret != 32)
    {
        goto uavcan_cocobot_Position_error_exit;
    }
    ...
    ret = canardDecodeScalar(transfer, offset, 32, false, (void*)&dest->a);
    if (ret != 32)
    {
        goto uavcan_cocobot_Position_error_exit;
    }
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        ret = uavcan_cocobot_Position_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
